let calculateWage = {
  ...
  biweeklySalaryPayCalculator: function (n) {
    let employeeWage = n;
    ...
    let biweeklyPay = monthlyPay / 2;
    return biweeklyPay - biweeklyPay * totalWithdrawals;
  },
  ...
  totalTaxes: function (n) {
    ...
    return biweeklyPay * totalWithdrawals;
  },
...
button.addEventListener('click', function () {
  ...
  results.innerHTML =
    '$' + calculateWage.biweeklySalaryPayCalculator(wage).toFixed(2);
